...
def get_argparser_kallisto_part(parser):
    ...
    parser.add_argument("--kal",
                        ...
                        help='To work with kallisto quantification output. \
                              A collumn "kallisto" which contains the path of \
                              kallisto output folder for each sample, need to \
                              be added to the design file. By default EPCY \
                              will works on TPM unless --cpm is specified.',
                        action='store_true')
